...
func Print() {
	fmt.Println()
	fmt.Print(color.CYN + `   _____            __  _            __      ___  __` + color.RST + "\n")
	fmt.Print(color.CYN + `  / ___/___  ____  / /_(_)___  ___  / / |  /| | / /_  __` + color.RST + "\n")
	fmt.Print(color.CYN + `  \__ \/ _ \/ __ \/ __/ / __ \/ _ \/ /| | / | |/ /| |/_/` + color.RST + "\n")
	fmt.Print(color.CYN + ` ___/ /  __/ / / / /_/ / / / /  __/ / | |/ /|  / / >  <` + color.RST + "\n")
	fmt.Print(color.CYN + `/____/\___/_/ /_/\__/_/_/ /_/\___/_/  |___/ |_/ /_/|_|` + color.RST + "\n")
	fmt.Println()
